  ...
  try {
    ...
    switch (event.type) {
      case 'checkout.session.completed':
        ...
        // TODO: Update user premium status in Supabase database
        // await supabase.from('profiles').update({ is_premium: true, stripe_sub_id: subscriptionId }).eq('id', userId);
        break;
      ...
      case 'customer.subscription.deleted':
        ...
        // TODO: Revoke premium access in Supabase database
        // await supabase.from('profiles').update({ is_premium: false }).eq('stripe_sub_id', deletedSub.id);
        break;
